\subsection{Свойства функций, имеющих пределы: единственность, предел модуля, неравенства, теорема о зажатой функции}
...
\begin{tcolorbox}[title=1. Единственность предела]	
	...
	\begin{enumerate}
		...
		\begin{itemize}
			\item $\exists \delta_1: \forall x \in \mathring{U}_{\delta_1}(x_0) \Rightarrow f(x) \in (A-\varepsilon, A+\varepsilon)$
			\item $\exists \delta_2: \forall x \in \mathring{U}_{\delta_2}(x_0) \Rightarrow f(x) \in (B-\varepsilon, B+\varepsilon)$
		\end{itemize}
		\item Возьмем $\delta = \min(\delta_1, \delta_2)$. Тогда для любого $x \in \mathring{U}_\delta(x_0)$ значение $f(x)$ должно находиться одновременно в $\varepsilon$-окрестности $A$ и $B$.
