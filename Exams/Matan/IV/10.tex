...
\textbf{1. Разрывы первого рода} (оба односторонних предела существуют и конечны):
\begin{enumerate}
	\item \textbf{Устранимый разрыв:} $\lim_{x\to a} f(x)$ существует, но либо $f(a)$ не существует, либо $\lim \neq f(a)$.
	\item \textbf{Разрыв первого рода (скачок):} $\lim_{x\to a+0} f(x) \neq \lim_{x\to a-0} f(x)$.
\end{enumerate}

\textbf{2. Разрывы второго рода:}
